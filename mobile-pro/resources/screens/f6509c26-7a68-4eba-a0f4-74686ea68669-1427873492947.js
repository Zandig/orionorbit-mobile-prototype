jQuery("#simulation")
  .on("click", ".s-f6509c26-7a68-4eba-a0f4-74686ea68669 .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/475872a2-9eb9-4c74-acd2-f1933edf934b"
                  }
                }
              ]
            }
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/079809d6-1089-4776-bead-f8a5cb64d95a"
                  }
                }
              ]
            }
  ...
  .on("pageload", ".s-f6509c26-7a68-4eba-a0f4-74686ea68669 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
