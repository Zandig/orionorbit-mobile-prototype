jQuery("#simulation")
  .on("click", ".s-4742269a-3cdf-4209-aeab-ac1d6dcfd173 .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/f5ae4f09-ada8-4bc9-9add-ed9eec97e0d0"
                  }
                }
              ]
            }
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/2171d4db-6a3b-421b-aa83-d6bc51abef94"
                  }
                }
              ]
            }
  ...
  .on("pageload", ".s-4742269a-3cdf-4209-aeab-ac1d6dcfd173 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
