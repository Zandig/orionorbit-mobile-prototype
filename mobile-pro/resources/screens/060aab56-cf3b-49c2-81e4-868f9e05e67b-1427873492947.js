jQuery("#simulation")
  .on("click", ".s-060aab56-cf3b-49c2-81e4-868f9e05e67b .click", function(event, data) {
  ...
  .on("pageload", ".s-060aab56-cf3b-49c2-81e4-868f9e05e67b .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
